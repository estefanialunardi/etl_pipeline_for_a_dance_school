...
def course_choice (cours):
    ...
    if cours == "Carte 10 cours danse/PBT/BAT":
        ...
        if cours=='Pilates':
            heure= st.multiselect('Horaire', ['Lundi 9h-10h','Lundi 20h30-21h30','Mardi 9h-10h', 'Jeudi 20h-21h','Vendredi 9h-10h', 'Je voudrais un autre horaire'])
            courses_qtd +=len(heure)
        elif cours=='Classique Moyen':
            heure= st.multiselect('Horaire', ['Lundi 10h-11h30','Mercredi 19h30 - 21h', 'Mardi 18h-19h30', 'Je voudrais un autre horaire'])
            courses_qtd +=len(heure)
        elif cours=='Barre à Terre':
            heure= st.multiselect('Horaire', ['Lundi 12h15-13h15','Mercredi 9h-10h', 'Vendredi 19h30-21h' 'Je voudrais un autre horaire'])
            courses_qtd +=len(heure)
        elif cours=='Préparatoire':
            heure= st.multiselect('Horaire', ['Lundi 17h15-18h15', 'Je voudrais un autre horaire'])
            courses_qtd +=len(heure)
            ...
            heure= st.multiselect('Horaire', ['Mardi 19h45-21h15', 'Mercredi 19h30-21h', 'Samedi 101h-12h30', 'Je voudrais un autre horaire'])
            courses_qtd +=len(heure)
            ...
            heure= st.multiselect('Horaire', ['Jeudi 17h30-18h30', 'Je voudrais un autre horaire'])
            courses_qtd +=len(heure)
        elif cours=='Initiation':
            heure= st.multiselect('Horaire', ['Mardi 17h-18h', 'Je voudrais un autre horaire'])
            courses_qtd +=len(heure)
...
try:
    ...
    course = st.selectbox('Cours', ['Sélectionnez vos cours', 'Carte 10 cours danse/PBT/BAT', 'Carte pilâtes 10 cours', 'Carte pilâtes 20 cours', 'Cours Illimitées', 'Pilates', 'Classique 1','Classique 2','Classique Moyen','Classique Moyen Confirmé','Classique Interm. – Avancé',
            'Classique Intermédiaire', 'Classique Intermédiaire (Spetacle)', 'Classique Avancé', 'Pointes', 'Conteporain Enfants', 'Pointes', 'Préparatoire', 'Pointes Débutants', 'Pointes Intermédiaire / Avancé', 'Éveil', 
...
if courses_carte_danse == 1:
    price_carte_danse = 200
if courses_carte_pilates == 1:
    price_carte_pilates = 165
elif courses_carte_pilates == 2:
    price_carte_pilates = 285
