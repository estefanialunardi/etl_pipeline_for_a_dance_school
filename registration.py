        ...
        if len(mail)<1:
            ...
            if submitted:
                ...
                try:
                    ...
                    try: 
                        mySql_insert_query2 = f"""INSERT INTO coursedf24 (name, course, schedule, course2, schedule2, course3, schedule3) VALUES ('{name}', '{course}', '{schedule}','{course2}', '{schedule2}','{course3}', '{schedule3}'); """
